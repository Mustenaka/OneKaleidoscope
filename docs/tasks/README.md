...
| 卡 | 范围 | 状态 |
|---|---|---|
| [T-106](T-106.md) | R3 合同：projection 独立 cursor、可信 mobile ingress、TRANSPORT 0.1 | **active** |

## 已排队

| 卡 | 范围 | 前置 |
|---|---|---|
| [T-107](T-107.md) | hostd LAN broker、projection journal、配对/认证、Rust mobile core | T-106 |
