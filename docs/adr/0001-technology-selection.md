...
- 状态：**部分有效**（2026-07-28；2026-07-30 重新定基线）
- 仍有效：Rust、UniFFI、iroh、禁止 PTY/TUI/ANSI
- 已被取代：Claude 以 ACP 为唯一主路径（见 ADR-0009）；relay 是否必做取决于 G0（见 ADR-0011）；
  固定事件 enum 合同（见 ADR-0010）
- 决策人：项目负责人
- 起草：项目主管
